...
export default function AddID() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Object.entries(formData).forEach(([key, value]) => {
        if (key === "photo" && value) {
          data.append("photoFile", value); // use 'photoFile' as field name
        } else {
          data.append(key, value);
        }
      });

      await axios.post("/api/ids", data, {
  ...
  const inputStyle =
    "p-3 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white";
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen bg-gray-100 font-sans">
      ...
      <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:p-8 bg-white overflow-y-auto">
        <div
          className="max-w-4xl mx-auto flex flex-col-reverse lg:flex-col gap-8"
          ref={printRef}
        >
          {/* FORM */}
          <div className="w-full bg-white border border-gray-300 rounded-lg shadow-lg p-6">
            <h2 className="text-2xl font-bold text-center text-blue-900 mb-4 uppercase">
              NIRA ID Card
            </h2>
            <form
            ...
            >
              {[
                ...
                },
                {
                  ...
                  type: "select",
                  options: ["Male", "Female"],
                  icon: <FaTransgender className={iconStyle} />,
                },
                {
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full p-2 border-dashed border-2 border-blue-300 rounded-md cursor-pointer bg-white"
                  required
                />
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center sm:col-span-2 gap-4 pt-4">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-blue-600 text-white px-6 py-2 rounded-md shadow hover:bg-blue-700 transition"
                >
                  Download PDF
                </button>
              </div>
          ...
          >
            <div className="flex-1 pr-2">
              ...
              <div className="grid grid-cols-2 gap-x-2 gap-y-[2px] text-gray-800">
                ...
                <p>
                  <strong>POB:</strong> {formData.placeOfBirth || "-"}
                </p>
                <p>
                  <strong>Nation:</strong> {formData.nationality || "-"}
                </p>
                <p>
                  <strong>Parent:</strong> {formData.parentSerial || "-"}
                </p>
                <p>
                  <strong>Issue:</strong> {formData.dateOfIssue || "-"}
                </p>
                <p>
                  <strong>Expiry:</strong> {formData.dateOfExpiry || "-"}
                </p>
                <p>
            ...
            <div className="w-[75px] h-full flex items-center justify-center">
              {formData.photo ? (
                <img
                  ...
                  alt="Photo"
                  className="w-[60px] h-[70px] object-cover border rounded-md"
                />
              ) : (
                <p className="text-[8px] italic text-gray-400 text-center">
                  No photo
                </p>
              )}
            </div>
